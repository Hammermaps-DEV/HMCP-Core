...
class PHPMailer
{
     ...
     * @return boolean
     */
    protected function dummySend($header, $body)
    {
        $toArr = [];
        ...
        if ($this->SingleTo and count($toArr) > 1) {
            ...
            $msg = '###############################################################################<br>';
            $msg .=  var_export($this->Subject,true).var_export($body,true).var_export($header,true).var_export($params,true);
            $msg .= '<br>###############################################################################<br><br><br>';
            $result = file_put_contents(ROOT_PATH.'/logs/mails.log',preg_replace('/\<br(\s*)?\/?\>/i', PHP_EOL, $msg));
